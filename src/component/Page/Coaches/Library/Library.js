        ...
        <div>
            <Container maxWidth="xl">
                <Grid container spacing={3}>
                    ...
                    <Grid item xs={12} sm={6} className="butt" style={{ paddingTop: "45px",paddingBottom:"40px", display: "flex", justifyContent: "end" }}>
                        <Button variant="outlined"
                            ...
                            <DetailsOutlinedIcon style={{marginRight:"7px"}} />
                            Filter
                        </Button>
                        <Button variant="outlined"
                            className="size"
                        ...
                        <Dialog open={open} onClose={handleClose}>
                            <div style={{ display: "flex" }}>
                                ...
                                <IconButton onClick={handleClose}>
                                    <CloseIcon style={{ marginLeft: "211px", marginTop: "-40px", color: "rgba(12,11,69,255)" }} />
                                </IconButton>
                            </div>
                            <DialogContent>
            ...
            <Container maxWidth="xl">
            <Paper elevation={3} style={{ padding:"30px",marginBottom:"90px" }}>
                <ImageList cols={4}>
                    {itemData.map((item) => (
