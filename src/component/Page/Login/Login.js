                  ...
                  <Grid container spacing={2} className="firstsignin" style={{ margin: "0" }}>
                    <Grid item md={6} lg={6}>
                      <div className="sports-app"  >
                        ...
                        <h4 style={{ color: "white" }}> Lorem lpsum ddummycontent</h4>
                        <p className="pp" style={{ color: "white", }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit.<br />
                          Mauris ac ornare enim </p>
                      </div>
                    </Grid>
                    <Grid item md={6} lg={6}>
                      ...
                      <div className={classes.paper}>
                        ...
                        >
                          <InputLabel className="InputLabel"
                            style={{
                              color: "rgba(12,11,69,255)", padding: "5px",
                              display: "flex", fontSize: "15px", letterSpacing: "2px", fontWeight: "bold",
                              marginTop: "80px"
                            }}
                          >
                          ...
                          <Grid container justify="center">
                            <Button
                              style={{
                                ...
                                color: "white", borderRadius: " 28px 28px", padding: "10px 81px",
                                fontSize: "21px", marginTop: "60px"
                              }}
                              ...
                              // }}
                              size="medium" color="primary" className={classes.margin}>
                              SIGN IN
                            </Button>
                          </Grid>
